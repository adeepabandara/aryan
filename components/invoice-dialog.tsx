...
export function InvoiceDialog({ open, onOpenChange, onSave }: InvoiceDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Enter invoice details to generate a new customer invoice</DialogDescription>
        </DialogHeader>
